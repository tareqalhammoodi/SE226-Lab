...
print("This is a list of the words that starts with letter E :")
for letter in words :
    if letter[0] == "e":
        print(letter)
...
print("This is a list of the words that starts with letter HA :")
for letter in words :
    if letter[0] == "h" and letter[1] == "a":
        print(letter)

print("--------------------------------------------------------")

#Exercise-3
Input = int(input("Please enter a number (between 3 and 9) : "))
